    ...
    <div className="min-h-screen relative overflow-hidden bg-[#fcfaf8]">
      ...
      <main className="container mx-auto px-4 py-24 max-w-4xl">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-[#443b32]">Polityka Prywatności</h1>
          <p className="text-[#443b32]/70">Informacje o przetwarzaniu danych na stronie przedszkola</p>
        </div>
        <div className="space-y-6 bg-white/60 rounded-3xl p-6 sm:p-8">
          <p className="text-[#443b32]/80">Dokument w przygotowaniu. Prosimy o kontakt z sekretariatem w sprawach związanych z ochroną danych osobowych.</p>
        </div>
      </main>
      <Footer />
    </div>
